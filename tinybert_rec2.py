...
# Hard offline backstop: refuse any network access even if a local_files_only
# flag is ever missed. Set before transformers is imported.
...
# Default local path for the downloaded TinyBERT checkpoint.
